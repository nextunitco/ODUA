          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="space-y-3.5">
              ...
              <ul className="space-y-2 text-xs text-white/80 font-medium">
                ...
                <li>
                  <a href="https://www.odif.ng/" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-[#fce303] transition-colors cursor-pointer text-left flex items-center gap-1.5">
                    <ExternalLink className="w-3.5 h-3.5 text-emerald-400" /> Foundation Portal (odif.ng)
                  </a>
                </li>
                <li>
                ...
                <li>
                  <button onClick={() => setCurrentPage('Museum and Hall Of Fame')} className="hover:text-[#fce303] transition-colors cursor-pointer text-left flex items-center gap-1.5">
                    <span>🏛️</span> Museum & Hall of Fame
                  </button>
                </li>
              </ul>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 pb-10 border-b border-neutral-800">
            <div className="space-y-2 max-w-2xl">
              ...
              <h3 className="text-2xl sm:text-3xl font-serif font-black text-white tracking-tight">
                Enhancing Sustainable Wealth Across Southwest Nigeria
              </h3>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-neutral-900 border border-neutral-800 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-neutral-400">
            <p className="text-[11px] text-neutral-500">
              © {new Date().getFullYear()} Odu’a Investment Company Limited. Cocoa House, Ibadan.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-xs text-white/70 font-light">
              ...
              <li><a href="https://www.odif.ng/" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-[#fce303] hover:underline cursor-pointer text-left flex items-center gap-1">Foundation Portal (odif.ng) <ExternalLink className="w-3 h-3" /></a></li>
              ...
              <li><button onClick={() => setCurrentPage('Museum and Hall Of Fame')} className="hover:text-[#fce303] hover:underline cursor-pointer text-left flex items-center gap-1"><span>🏛️</span> Museum & Hall of Fame</button></li>
            </ul>
          </div>
